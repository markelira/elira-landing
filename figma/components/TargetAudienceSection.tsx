          ...
          {audiences.map((audience, index) => (
            <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="space-y-6">
                <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center text-blue">
                  {audience.icon}
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {['Technológia', 'Építőipar', 'Szolgáltatások', 'Kereskedelem', 'Gyártás', 'Egészségügy'].map((industry) => (
                  <span key={industry} className="px-4 py-2 bg-blue-100 text-blue rounded-full text-sm">
                    {industry}
                  </span>
                ))}
              </div>
