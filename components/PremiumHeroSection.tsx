      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-16 sm:py-20 lg:py-24 relative z-10">
        <div className="flex flex-col items-center gap-8 lg:gap-12 min-h-[80vh] justify-center">
          ...
          <div className="space-y-6 sm:space-y-8 lg:space-y-10 text-center max-w-4xl">
              ...
              <div className="relative rounded-2xl sm:rounded-[32px] p-3 sm:p-4"
                ...
                >
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <span className="text-white font-semibold text-xs sm:text-sm">Online</span>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <span className="text-white font-semibold text-xs sm:text-sm">Masterclassok</span>
                  </div>
                </motion.div>
            ...
            {/* Trust Section - iOS Liquid Glass Card */}
            <motion.div
              ...
              <svg width="0" height="0" className="absolute">
                <defs>
                  <filter id="liquidGlassDistortion" x="-20%" y="-20%" width="140%" height="140%">
                    {/* Noise generation for organic distortion */}
                    <feTurbulence
                      type="fractalNoise"
                      ...
                      seed="2"
                    />
                    {/* Displacement for watery glass effect */}
                    <feDisplacementMap
                      in="SourceGraphic"
                      in2="noise"
                      scale="12"
